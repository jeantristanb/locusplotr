...
gg_gc<- function(chr, start, end, genome_build = "GRCh38", max_levels = 5, gwas_cat_db=NULL) {
  ...
  # Create the plot
  p <- ggplot(gc, aes(x= bp)) + geom_segment(aes(x = start, xend = end, yend = y_level), linewidth = 2, color = "darkblue") #+
